...
| The schema, fictional replay, synthetic Random Forest demo, and pinned TabPFN comparison are executable | A real organisational dataset, validated organisational model, or deployed integration exists here |
